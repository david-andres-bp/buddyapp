...
<div class="space-y-8">
    <div class="flex justify-between items-center">
        ...
        <a href="/messages/new" class="bg-coral text-white font-semibold px-6 py-2 rounded-full hover:bg-coral-dark transition">New Message</a>
    </div>
        ...
        <?php else : ?>
            <div class="space-y-4">
                <?php foreach ($threads as $thread) : ?>
                    <a href="/messages/<?= $thread->id ?>" class="block p-4 border rounded-lg hover:bg-gray-50">
